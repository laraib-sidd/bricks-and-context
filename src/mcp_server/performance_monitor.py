...
class PerformanceMonitor:
    ...
    def record_operation(self, operation: str, duration_ms: float, success: bool = True, error_message: Optional[str] = None):
...
def record_operation(operation: str, duration_ms: float, success: bool = True, error: Optional[str] = None):
    """Record a completed operation metric."""
